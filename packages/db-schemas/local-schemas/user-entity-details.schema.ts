...
@Table({ tableName: "user_entity_details", timestamps: true })
export class UserEntityDetailsModel extends Model<UserEntityDetailsModel, UserEntityDetailsAttributes> {
  @PrimaryKey
  @AutoIncrement
