...
import type { ArtistUploadStatus } from "../src/enums/user.enum";
...
@Table({ tableName: "artist_uploads", timestamps: true })
export class ArtistUploadModel extends Model<ArtistUploadModel, ArtistUploadAttributes> {
  @PrimaryKey
  @AutoIncrement
