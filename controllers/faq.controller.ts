...
export const getFaqs = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    ...
    data: response,
    message: ResponseMessages.GetFaqsSuccess,
  });
});
...
export const createFaq = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    ...
    data: response,
    message: ResponseMessages.FaqCreatedSuccess,
  });
});
...
export const updateFaq = catchAsync(async (req: AuthRequest, res: Response) => {
  ...
  sendResponse(res, {
    status: HttpStatusCode.OK,
    data: response,
    message: ResponseMessages.FaqUpdatedSuccess,
  });
});
...
export const deleteFaq = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    status: HttpStatusCode.OK,
    data: null,
    message: ResponseMessages.FaqDeletedSuccess,
  });
});

export const reorderFaqs = catchAsync(async (req: Request, res: Response) => {
  const response = await reorderFaqsService(req.body);
  sendResponse(res, {
    status: HttpStatusCode.OK,
    data: response,
    message: ResponseMessages.FaqsReorderedSuccess,
  });
});
