...
@Table({
  tableName: "user_form_questions",
  timestamps: true,
})
export class UserFormQuestionModel extends Model<
  UserFormQuestionModel,
  UserFormQuestionAttributes
> {
  @PrimaryKey
  @AutoIncrement
  @Column(DataType.BIGINT)
...
export interface UserFormAnswerAttributes {
  id?: number;
  formId: number;
  questionId: number;
  userId: number;
...
@Table({
  tableName: "user_form_answers",
  timestamps: true,
})
export class UserFormAnswerModel extends Model<
  UserFormAnswerModel,
  UserFormAnswerAttributes
> {
  @PrimaryKey
  @AutoIncrement
  @Column(DataType.BIGINT)
